# -*- coding: utf-8 -*-
"""qcnn_denoising.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1vCJ3o4un4_dtGQWC3frB8kyR78ZzI1S8
"""
...
print(f"\n🚀 Training Completed in {int(elapsed_time // 60)} min {int(elapsed_time % 60)} sec")

history_dict = history.history
num_epochs = len(history_dict['loss'])

csv_filename = f"qcnn_comparison_plot_{epochs}_epochs.csv"
...
plot_filename_loss = f"qcnn_loss_plot_{epochs}_epochs.png"
plot_filename_psnr = f"qcnn_psnr_plot_{epochs}_epochs.png"
plot_filename_ssim = f"qcnn_ssim_plot_{epochs}_epochs.png"
plot_filename_comparison = f"qcnn_comparison_plot_{epochs}_epochs.png"
